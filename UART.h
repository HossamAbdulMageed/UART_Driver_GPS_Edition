...
UART_ChkType UART_Tx_Init(const uint8_t* TxBuffPtr, uint16_t TxLen, uint8_t groupID);
UART_ChkType UART_Tx (uint8_t groupID);
UART_ChkType UART_Rx_Init (uint8_t* RxBuffPtr, uint16_t RxLen, uint8_t groupId);
